# Rafa R. Galván, theme forked from essembeh.zsh-theme
# My custom theme:
#   - single line
...
PROMPT='${ZSH_ESSEMBEH_PREFIX}%{$fg[$ZSH_ESSEMBEH_COLOR]%}%n@%M%{$reset_color%}:%{%B$fg[yellow]%}%C/%{$reset_color%b%} $(zsh_essembeh_gitstatus)%(!.#.$) '
